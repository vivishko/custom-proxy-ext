...
| IMPROVE-18 | 18. After saving proxy, open proxies table | H7 | P1 | S | 🟣 idea | 2026-02-08 | - | - | docs/roadmap/improve-18-after-saving-proxy-open-proxies-table.md | Improve post-save flow by taking users to proxy list | - |
